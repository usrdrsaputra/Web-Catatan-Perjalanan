...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/style.userr.css">
    ...
    <div class="wrapper">
        ...
        <aside id="sidebar">
            <div class="h-100">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="?page=pencatatan" class="sidebar-link">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="?page=profil" class="sidebar-link">Profil</a>
                            </li>
                            <li class="sidebar-item">
        ...
        <div class="main">
            <nav class="navbar navbar-expand px-3 border-bottom bg-white">
                ...
                <button class="btn" type="button" data-bs-theme="white">
